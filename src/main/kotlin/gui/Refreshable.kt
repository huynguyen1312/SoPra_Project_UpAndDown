...
interface Refreshable {
    ...
    /**
     * Refreshes the UI or game state after the end of a turn.
     * Called when a player's turn ends, ensuring the game state is properly updated.
     */
    fun refreshAfterEndTurn() {}

    /**
     * Refreshes the UI or game state after a player swaps cards.
     * @param player The player who performed the card swap.
     */
    fun refreshAfterSwapCards(player: Player){}
     ...
     */
    fun refreshAfterPlayCard(card: Card, stackID: Int){}
