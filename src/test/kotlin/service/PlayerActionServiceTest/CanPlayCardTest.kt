...
class CanPlayCardTest {
    ...
    fun possibleOrImpossibleToPlayCard() {
        ...
        assertEquals(game.centerStack1.last(), Card(CardSuit.HEARTS, CardValue.TWO) )

        assertTrue(rootService.playerActionService.canPlayCard(Card(CardSuit.CLUBS, CardValue.THREE), 0))
