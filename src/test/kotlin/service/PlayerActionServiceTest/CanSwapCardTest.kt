...
class CanSwapCardTest {
     ...
     *
     * Steps:
     * 1. If the player's draw stack is empty and the numbers of hand cards is smaller than 8, they should not be able to draw a card.
     * 2. If at least one card is added to the draw stack, but the numbers of hand cards is still smaller than 8, they should not be able to draw a card.
     * 3. f at least one card is added to the draw stack and the numbers of hand cards is greater than 8, they should be able to draw a card.
     */
    @Test
