...
class StartGameTest {
    ...
    fun correctInitiationOfGameTest() {
        ...
        rootService.gameService.startGame(player1.name, player2.name)
        ...
        assertEquals(20, game.players[0].drawStack.size, "Player 1 should have 20 cards in draw stack")
        assertEquals(20, game.players[1].drawStack.size, "Player 2 should have 20 cards in draw stack")
    ...
    fun blankNameTest() {
        val exception = assertThrows<IllegalArgumentException> {
            rootService.gameService.startGame("", "Duc")
        }
    ...
    fun duplicateNameTest() {
        val exception = assertThrows<IllegalArgumentException> {
            rootService.gameService.startGame("Huy", "Huy")
        }
    ...
    fun tooLongNameTest() {
        val exception = assertThrows<IllegalArgumentException> {
            rootService.gameService.startGame("ThisNameIsWayTooLongForTheGame", "Duc")
        }
    ...
    fun allCardsAreUniqueTest() {
        ...
        assertEquals(player1DrawCards.size, player1DrawCards.toSet().size, "Player 1 draw stack should have unique cards")
        assertEquals(player1HandCards.size, player1HandCards.toSet().size, "Player 1 hand cards should be unique cards")
        assertEquals(player2DrawCards.size, player2DrawCards.toSet().size, "Player 2 draw stack should have unique cards")
        assertEquals(player2HandCards.size, player2HandCards.toSet().size, "Player 2 hand cards should be unique cards")
    }
